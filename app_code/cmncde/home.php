...
<div class="row">
    <div class="col-lg-3 col-md-6">
        <div class="panel" style="color:white;background-color:#5cb85c;border-radius:5px;border:1px solid #5cb85c;">
            <a href="javascript:openAHomeTab('myinbox');">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-default" style="color:white;background-color:#337ab7;border-radius:5px;border:1px solid #337ab7;" >
            <a href="javascript:openAHomeTab('allarticles');">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-default" style="color:white;background-color:#f0ad4e;border-radius:5px;border:1px solid #f0ad4e;">
            <a href="javascript:openAHomeTab('profile');">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-default" style="color:white;background-color:#d9534f;border-radius:5px;border:1px solid #d9534f;">
            <a href="javascript:openAHomeTab('allmodules');">
...
<div class="row">
    <div class="col-lg-12">
        <!-- Carousel-->
        <div class="" style="border: 1px solid #ddd;border-radius: 1px;padding:0px;background-color:#fff;margin-bottom:7px;">
        ...
        <div class="row">
            <div class="col-lg-12" >
                <div class="introMsg">Welcome, MR. SYSTEM USER SETUP (RHO0002012) to the <?php echo $app_name; ?>!</div>
        ...
        <div class="" style="border: 1px solid #ddd;border-radius: 5px;">
            <div class="container-fluid">
                <!-- Example row of columns -->
                <div class="row">
                    <div class="col-md-4">
