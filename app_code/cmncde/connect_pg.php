...
$app_name = "Rhomicom Systems Tech. Ltd. - Partnership Portal";
$app_version = "V1 P24";
...
$app_image = "3.png";
$app_image1 = "3.png";
$lgn_image = "background_lgn.jpg";
$app_favicon = "Icon.ico";
$about_app = "About Rhomicom";
$about_url = "http://www.rhomicom.com";
$bckcolors = "background-repeat: repeat;background-color: #003245 !important;background-image:url('cmn_images/background_lgn12.jpg'); background-size:100% 100%;";
$bckcolorsChngPwd = "background: url('cmn_images/background_lgn12.jpg') no-repeat center center fixed; 
